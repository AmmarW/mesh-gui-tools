...
public:
    ...
    // Suggest minimum TPS thickness to keep all interface temperatures below their maxima:
    //   - steel/glue ≤ maxSteelTemp
    //   - glue/carbon ≤ maxGlueTemp
    //   - carbon/external ≤ maxCarbonTemp
    double suggestTPSThickness(const Stack& stack,
                                   double maxSteelTemp,
                                   double maxGlueTemp,
