/**
 * @file MeshValidator.cpp
 * @brief Implements validation functions for ensuring mesh integrity.
 */
 ...
 /**
  * @brief Validates the given mesh for various conditions and returns a list of error messages.
  *
